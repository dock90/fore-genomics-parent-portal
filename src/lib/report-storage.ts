...
class ReportStorageService {
  ...
  constructor() {
    ...
    if (isTestMode) {
      ...
      this.bucketName = process.env.GOOGLE_CLOUD_REPORTS_BUCKET || 'fore-genomics-reports-test';
    } else {
      // Production uses separate bucket
      this.bucketName = process.env.GOOGLE_CLOUD_REPORTS_BUCKET || 'fore-genomics-reports-prod';
    }
  }
