...
export default function ConsentStep({ consentAccepted, setConsentAccepted, onNext, onBack, childInfo, userInfo }: any) {
  ...
  const handleScroll = (event: React.UIEvent<HTMLDivElement>, setScrolled: (scrolled: boolean) => void) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
      ...
      <input type="hidden" name="consentAll" value={consentAll ? "on" : "off"} />
      ...
      <div className="space-y-4 sm:space-y-6">
        <div className="text-center sm:text-left">
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground">Fore Genomics Consent</h2>
        </div>
        ...
        <div className="border rounded-lg p-4 sm:p-6 bg-muted/50 space-y-6 sm:space-y-8">
          ...
          <div className="text-sm sm:text-base text-muted-foreground space-y-4 border rounded p-4 bg-background">
            <p>
              The Fore Genomics Pediatric Health Screen is developed based on a list of genes and related disease predispositions curated by Fore Genomics, Inc. Fore Genomics Pediatric Health Screen test involves the following service providers to provide the test. The genetic counseling is provided by Grey Genetics, LLC, with genetic counselors available in all 50 states. The physician authorization is provided by DNA Ally, a nationwide network of healthcare providers. The genetic test (including sequencing of samples, data analysis, and report generation) is performed by Inocras, Inc. at its CLIA-certified and CAP-accredited clinical laboratory located in San Diego, CA.
            </p>
          </div>

          {/* PART 1: Informed Consent to Fore Genomics Services */}
          <div className="space-y-4">
            <h3 className="text-lg sm:text-xl font-semibold text-foreground">PART 1: Informed Consent to Fore Genomics Services</h3>
            <div 
            ...
            <div className="flex items-start space-x-3 pt-4 border-t">
              ...
              >
                I have read, understood, and agree to the Informed Consent to Fore Genomics Services described in PART 1
                {!part1Scrolled && <span className="block text-xs text-muted-foreground mt-1">Please read the content above in its entirety to enable this checkbox</span>}
              </Label>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-lg sm:text-xl font-semibold text-foreground">PART 2: Informed Consent for Genetic Testing</h3>
            <div 
              className="text-sm sm:text-base text-muted-foreground space-y-4 max-h-96 overflow-y-auto border rounded p-4 bg-background"
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-2">
                    Testing is performed on a sample of your DNA collected on your buccal (cheek) swab and sent to us ("Sample"). Once collected, WGS will be performed on your Sample producing a large amount of genetic information. The WGS analysis can take into account any submitted clinical history, family history as well as currently available genetic information in medical literature and databases.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-3">
                    ...
                    <div className="ml-4 mt-2 space-y-2">
                      <div><strong>a. Positive, and may:</strong>
                      ...
                      <div><strong>b. Negative, and may:</strong>
                        <ul className="list-disc list-inside ml-4 space-y-1">
                      ...
                      <div><strong>c. Of uncertain significance, and may:</strong>
                        <ul className="list-disc list-inside ml-4 space-y-1">
                      ...
                      <div><strong>d. Other than positive, negative or uncertain that reveals family relationships that do not conform to the family's view of such relationships. If such results have no impact on the health of the individual being tested, such findings are not communicated nor reported.</strong></div>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <p className="mt-2">
                    Test reports are released to the certified healthcare provider(s) that orders your test. A copy will be provided to you by us through Fore Genomics if you request it. Test reports are confidential and will only be shared in accordance with applicable laws. Your test report is available for you to download from the Fore Genomics patient portal or can be requested by phone, email, or fax.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2">
                    We may retain your data and Sample for as long as necessary for the purposes described above.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2">
                    We provide more information on how your data is used and shared through its Privacy Policy and HIPAA Notice of Privacy Practices. You can receive these documents by emailing <a href="mailto:inquiry@inocras.com" className="text-blue-600 underline">inquiry@inocras.com</a>.
                  </p>
                </div>
            ...
            <div className="flex items-start space-x-3 pt-4 border-t">
              ...
              >
                I have read, understood, and agree to the Informed Consent for Genetic Testing described in PART 2
                {!part2Scrolled && <span className="block text-xs text-muted-foreground mt-1">Please read the content above in its entirety to enable this checkbox</span>}
              </Label>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-lg sm:text-xl font-semibold text-foreground">PART 3: Informed Consent for Telehealth Services</h3>
            <div 
              className="text-sm sm:text-base text-muted-foreground space-y-4 max-h-96 overflow-y-auto border rounded p-4 bg-background"
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-2">The types of electronic transmissions that may occur using the telehealth platform include, but are not limited to:</p>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                    ...
                    <li>In the event of an inability to communicate as a result of a technological or equipment failure, please contact the Group at (800) 277-5098 AND <a href="mailto:yourfriends@DNAAlly.com" className="text-blue-600 underline">yourfriends@DNAAlly.com</a>.</li>
                ...
                <div>
                  ...
                  <p className="mt-2">I further acknowledge, understand, and agree to the following:</p>
                  <ol className="list-decimal list-inside ml-4 space-y-1 mt-2">
                    ...
                    <li>I have the right to request a copy of my medical records. I can request to obtain or send a copy of my medical records to my primary care or other designated health care provider by contacting Group at: <a href="mailto:yourfriends@dnaally.com" className="text-blue-600 underline">yourfriends@dnaally.com</a>. A copy will be provided to me at reasonable cost of preparation, shipping and delivery.</li>
                ...
                <div>
                  ...
                  <p className="mt-2">The following consents apply to patients accessing Group's website for the purposes of participating in a telehealth consultation as required by the states listed below:</p>
                  
                  <div className="space-y-3 mt-3">
                    <div>
                      <strong>Iowa:</strong> I have been informed that if I want to register a formal complaint about a provider, I should visit the medical board's website, here: <a href="https://medicalboard.iowa.gov/consumers/filing-complaint" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">https://medicalboard.iowa.gov/consumers/filing-complaint</a>
                    </div>
                    
                    <div>
                      <strong>Idaho:</strong> I have been informed that if I want to register a formal complaint about a provider, I should visit the medical board's website, here: <a href="https://bom.idaho.gov/BOMPortal/AgencyAdditional.aspx?Agency=425&AgencyLinkID=650" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">https://bom.idaho.gov/BOMPortal/AgencyAdditional.aspx?Agency=425&AgencyLinkID=650</a>
                    </div>
                    
                    <div>
                      <strong>Indiana:</strong> I have been informed that if I want to register a formal complaint about a provider, I should visit the medical board's website, here: <a href="https://www.in.gov/attorneygeneral/2434.htm" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">https://www.in.gov/attorneygeneral/2434.htm</a>
                    </div>
                    
                    <div>
                      <strong>Kentucky:</strong> I have been informed that if I want to register a formal complaint about a provider, I should visit the medical board's website, here: <a href="https://kbml.ky.gov/grievances/Pages/default.aspx" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">https://kbml.ky.gov/grievances/Pages/default.aspx</a>
                    </div>
                    
                    <div>
                      <strong>Maine:</strong> I have been informed that if I want to register a formal complaint about a provider, I should visit the medical board's website, here: <a href="https://www.maine.gov/md/discipline/file-complaint.html" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">https://www.maine.gov/md/discipline/file-complaint.html</a>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside ml-4 mt-1 space-y-1">
                        <li>Oklahoma Board of Medical Licensure and Supervision: <a href="http://www.okmedicalboard.org/complaint" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">http://www.okmedicalboard.org/complaint</a></li>
                        <li>Oklahoma Board of Osteopathic Examiners: <a href="https://www.ok.gov/osboe/faqs.html" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">https://www.ok.gov/osboe/faqs.html</a></li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside ml-4 mt-1 space-y-1">
                        <li>Vermont Board of Medical Practice: <a href="http://www.healthvermont.gov/health-professionals-systems/board-medical-practice/file-complaint" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">http://www.healthvermont.gov/health-professionals-systems/board-medical-practice/file-complaint</a></li>
                        <li>Vermont Board of Osteopathic Examiners: <a href="http://www.healthvermont.gov/health-professionals-systems/board-osteopathic-examiners" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">http://www.healthvermont.gov/health-professionals-systems/board-osteopathic-examiners</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex items-start space-x-3 pt-4 border-t">
              ...
              >
                I have read, understood, and agree to the Informed Consent for Telehealth Services described in PART 3
                {!part3Scrolled && <span className="block text-xs text-muted-foreground mt-1">Please read the content above in its entirety to enable this checkbox</span>}
              </Label>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
                <Label htmlFor="relationshipToChild" className="text-sm font-medium">
            ...
            <div className="flex items-start space-x-3 pt-4">
              ...
              >
                I have reviewed, understand, and agree to the Fore Genomics Consent
              </Label>
            </div>
