...
const WEBHOOK_URL =
  "https://fore-genomics-parent-portal-env-staging-adam-lands-projects.vercel.app/api/webhooks/calendly";
...
async function listWebhooks() {
  try {
    ...
    const response = await calendlyService.makeRequest(
...
async function createWebhook(url, events, organizationUri) {
  try {
    ...
    if (signingKey) {
      ...
      console.log("");
      console.log(
        "📝 Add this signing key to your staging environment variables:"
      );
